...
<main id="home" class="relative">
    ...
    <div class="grid items-center gap-10 md:grid-cols-12">
      <div class="md:col-span-7">
        ...
        <!-- <p class="mt-4 max-w-xl text-white/70 leading-relaxed reveal">
          I am an IT fresh graduate focused on Flutter, Java, and Visual Basic
          projects, with a growing foundation in troubleshooting, system
          support, and practical software development.
        </p> -->
        ...
        <div class="mt-9 grid grid-cols-3 gap-3 max-w-md reveal">
          ...
          <div class="rounded-2xl border border-white/10 bg-white/5 p-4">
            ...
            <p class="text-xs text-white/60">Projects and support skills</p>
          </div>
        </div>
      </div>
  ...
  <section id="projects" class="mx-auto max-w-6xl px-4 pt-16">
    ...
    <div class="mt-8 grid gap-5 md:grid-cols-3">
      <!-- Card 1: Classkit -->
      <article
        class="reveal flex h-full flex-col rounded-3xl border border-white/10 bg-white/5 p-6 transition hover:bg-white/8 hover:border-white/15"
      >
    ...
    >
      <div
        class="modal-scroll relative w-full max-w-5xl rounded-3xl border border-white/10 bg-zinc-950 p-5 sm:p-7 md:p-8 shadow-2xl ring-1 ring-white/10 max-h-[92vh] overflow-y-auto"
        role="dialog"
        aria-modal="true"
      ...
      >
        ...
        <div class="flex flex-col gap-4 border-b border-white/10 pb-5 sm:flex-row sm:items-start sm:justify-between">
          <div class="space-y-1.5">
            <div class="flex flex-wrap items-center gap-2">
              <span
                ...
                class="inline-flex items-center gap-1.5 rounded-full border border-indigo-400/30 bg-indigo-500/15 px-3 py-0.5 text-xs font-semibold uppercase tracking-[0.2em] text-indigo-300"
              >
                Mobile Application
              </span>
              <span
          ...
          <div class="flex items-center gap-2 self-start sm:self-auto">
            ...
            <button
              type="button"
              data-project-close
              class="inline-flex items-center gap-2 rounded-xl border border-white/10 bg-white/5 px-3.5 py-2 text-sm font-medium text-white/80 transition hover:bg-white/10 hover:text-white"
        ...
        <div class="mt-6 grid gap-8 lg:grid-cols-12 items-start">
          ...
          <div class="lg:col-span-7 flex flex-col gap-4">
            ...
            <div
              id="carouselStage"
              class="relative flex flex-col items-center justify-center rounded-2xl border border-white/10 bg-black/60 p-4 sm:p-6 min-h-[380px] sm:min-h-[460px] overflow-hidden group select-none"
            >
              ...
              <button
                type="button"
                id="carouselPrevBtn"
                class="absolute left-2 sm:left-3 top-1/2 -translate-y-1/2 z-30 flex h-10 w-10 sm:h-11 sm:w-11 items-center justify-center rounded-full border border-white/20 bg-black/80 text-white backdrop-blur transition hover:bg-indigo-600 hover:border-indigo-400 hover:scale-105 active:scale-95 shadow-xl focus:outline-none focus:ring-2 focus:ring-indigo-400"
              ...
              <button
                type="button"
                id="carouselNextBtn"
                class="absolute right-2 sm:right-3 top-1/2 -translate-y-1/2 z-30 flex h-10 w-10 sm:h-11 sm:w-11 items-center justify-center rounded-full border border-white/20 bg-black/80 text-white backdrop-blur transition hover:bg-indigo-600 hover:border-indigo-400 hover:scale-105 active:scale-95 shadow-xl focus:outline-none focus:ring-2 focus:ring-indigo-400"
              ...
              >
                <div class="desktop-mockup-frame rounded-2xl border border-zinc-700/80 bg-zinc-900 shadow-2xl ring-1 ring-white/15 overflow-hidden">
                  ...
                  <div class="flex items-center justify-between border-b border-white/10 bg-zinc-950/80 px-4 py-2.5">
                    <div class="flex items-center gap-2">
                    ...
                    <span
                      ...
                      class="text-[11px] font-mono text-white/50 truncate max-w-[240px]"
                    >
                  ...
                  <div class="bg-black/60 p-2 flex items-center justify-center min-h-[260px] sm:min-h-[320px]">
                    <img
            ...
            <div class="rounded-2xl border border-white/10 bg-white/5 p-4 backdrop-blur">
              <div class="flex items-center justify-between gap-3">
                ...
                <span
                  ...
                  class="rounded-full bg-indigo-500/20 px-2.5 py-0.5 text-[11px] font-mono text-indigo-300 ring-1 ring-indigo-400/20"
                >
                  Slide 1
                </span>
              </div>
            ...
            <div class="rounded-2xl border border-white/10 bg-white/5 p-3.5">
              <div class="flex items-center justify-between text-xs text-white/60 mb-2.5">
              ...
              <div
                ...
                class="carousel-scroll flex gap-2 overflow-x-auto py-1.5 px-0.5 select-none"
              >
          ...
          <div class="lg:col-span-5 flex flex-col gap-6">
            ...
            <div class="grid grid-cols-2 gap-2.5 sm:gap-3">
              <div class="rounded-2xl border border-white/10 bg-white/5 p-3.5">
                ...
                <p id="statPlatform" class="mt-1 text-sm font-semibold text-white">Android</p>
              </div>
              <div class="rounded-2xl border border-white/10 bg-white/5 p-3.5">
                <p class="text-[11px] uppercase tracking-wider text-white/50">Architecture</p>
                <p id="statArchitecture" class="mt-1 text-sm font-semibold text-white">Flutter / Dart</p>
              </div>
              <div class="rounded-2xl border border-white/10 bg-white/5 p-3.5">
                <p class="text-[11px] uppercase tracking-wider text-white/50">Screens</p>
                <p id="statScreens" class="mt-1 text-sm font-semibold text-indigo-300">18 Screens</p>
              </div>
              <div class="rounded-2xl border border-white/10 bg-white/5 p-3.5">
                <p class="text-[11px] uppercase tracking-wider text-white/50">Type</p>
                <p id="statType" class="mt-1 text-sm font-semibold text-white">POS Application</p>
              </div>
            </div>
    ...
    <div
      ...
      class="pointer-events-none fixed inset-0 z-60 hidden items-center justify-center bg-black/90 backdrop-blur-lg p-4 opacity-0 transition duration-200"
      aria-hidden="true"
    >
      <div class="relative flex flex-col items-center justify-center max-h-full max-w-full">
        ...
        <button
          type="button"
          id="lightboxCloseBtn"
          class="absolute -top-12 right-0 sm:right-2 z-70 flex h-10 w-10 items-center justify-center rounded-full border border-white/20 bg-black/80 text-white hover:bg-white/20 transition"
        ...
        <button
          type="button"
          id="lightboxPrevBtn"
          class="absolute left-2 sm:-left-14 top-1/2 -translate-y-1/2 z-70 flex h-12 w-12 items-center justify-center rounded-full border border-white/20 bg-black/80 text-white hover:bg-indigo-600 transition shadow-xl"
          aria-label="Previous screen"
        >
        ...
        <button
          type="button"
          id="lightboxNextBtn"
          class="absolute right-2 sm:-right-14 top-1/2 -translate-y-1/2 z-70 flex h-12 w-12 items-center justify-center rounded-full border border-white/20 bg-black/80 text-white hover:bg-indigo-600 transition shadow-xl"
          aria-label="Next screen"
        >
          <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5l7 7-7 7"/>
        ...
        <img
          ...
          class="max-h-[80vh] max-w-[92vw] object-contain rounded-2xl border border-white/10 shadow-2xl"
        />
    ...
    <div class="grid gap-8 md:grid-cols-12 md:items-start">
      <div class="reveal md:col-span-5">
        ...
        <p class="mt-3 text-sm leading-relaxed text-white/70">
          IT graduate with hands-on experience in Software Development and hardware/OS troubleshooting (IT Support). Eager to apply strong analytical and problem-solving skills to develop efficient software solutions while ensuring system stability and end-user support.
        </p>
          ...
          <div class="mt-4 grid gap-3">
            <div class="flex items-center justify-between text-sm">
              ...
              <span class="font-semibold text-white/90"
                >Software Development / IT Support</span
              >
            </div>
            <div class="flex items-center justify-between text-sm">
      ...
      <div class="reveal md:col-span-7">
        <div class="rounded-3xl border border-white/10 bg-white/5 p-6">
          ...
          <div class="mt-5 grid gap-3 sm:grid-cols-2">
            ...
            <div class="rounded-2xl border border-white/10 bg-black/20 p-4">
              <p class="text-sm font-semibold">Troubleshooting support</p>
              <p class="mt-2 text-sm text-white/70">
                Diagnosing and resolving software issues, setup problems, and
    ...
    >
      ...
      >
        <div>
          ...
          <p class="mt-3 max-w-xl text-sm leading-relaxed text-white/70">
            If you are looking for an entry-level developer or IT support
            assistant who is ready to learn and contribute, feel free to reach
            out.
          </p>
        </div>
      ...
      >
        ...
        <div class="flex flex-wrap gap-2">
          ...
          <a
            href="https://github.com/sleepy-shan"
            target="_blank"
            rel="noopener noreferrer"
            class="inline-flex items-center justify-center rounded-xl border border-white/10 bg-white/5 px-4 py-2 text-sm font-semibold text-white/90 hover:bg-white/10 transition"
          >
      ...
      <div class="mt-7 grid gap-4 sm:grid-cols-3">
        ...
        <div class="rounded-2xl border border-white/10 bg-black/20 p-4">
          ...
          <p class="mt-1 text-sm font-semibold">Software development and IT support</p>
        </div>
      </div>
    </div>
  </section>
