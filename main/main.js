const MAIN_FRAGMENT_HTML = `<main id="home" class="relative">
  ...
  <section id="projects" class="mx-auto max-w-6xl px-4 pt-16">
    ...
    >
      <div
        class="resume-printable modal-scroll relative w-full max-w-4xl rounded-3xl border border-white/10 bg-zinc-950 p-5 sm:p-8 md:p-10 shadow-2xl ring-1 ring-white/10 max-h-[92vh] overflow-y-auto"
        role="dialog"
        aria-modal="true"
      ...
      >
        ...
        <div class="flex flex-col gap-4 border-b border-white/10 pb-6 sm:flex-row sm:items-start sm:justify-between">
          <div>
            <div class="flex flex-wrap items-center gap-2">
              <span class="inline-flex items-center gap-1.5 rounded-full border border-indigo-400/30 bg-indigo-500/15 px-3 py-0.5 text-xs font-semibold uppercase tracking-[0.2em] text-indigo-300">
                Curriculum Vitae
              </span>
            ...
            <div class="mt-2.5 flex flex-wrap items-center gap-x-4 gap-y-1 text-xs text-white/60">
              ...
              <span class="inline-flex items-center gap-1">
                <svg class="h-3.5 w-3.5 text-indigo-400" fill="currentColor" viewBox="0 0 24 24">
        ...
        <!-- Resume Body -->
        <div class="mt-6 space-y-6 text-sm text-white/80">
            ...
            <div class="mt-2.5 space-y-3">
              <div class="rounded-2xl border border-white/10 bg-white/5 p-4">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-1">
                  <div class="flex items-center gap-2">
                    <h5 class="font-semibold text-white">Classkit — POS &amp; Inventory Mobile App</h5>
                    <span class="rounded-full bg-indigo-500/20 px-2 py-0.5 text-[10px] font-mono text-indigo-300">Flutter • Android</span>
                  </div>
              ...
              <div class="rounded-2xl border border-white/10 bg-white/5 p-4">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-1">
                  <div class="flex items-center gap-2">
                    <h5 class="font-semibold text-white">Arcade Suite — Desktop Game Collection</h5>
                    <span class="rounded-full bg-fuchsia-500/20 px-2 py-0.5 text-[10px] font-mono text-fuchsia-300">VB.NET • WinForms</span>
                  </div>
              ...
              <div class="rounded-2xl border border-white/10 bg-white/5 p-4">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-1">
                  <div class="flex items-center gap-2">
                    <h5 class="font-semibold text-white">Java POS &amp; Inventory Management System</h5>
                    <span class="rounded-full bg-cyan-500/20 px-2 py-0.5 text-[10px] font-mono text-cyan-300">Java Swing • MVC</span>
                  </div>
