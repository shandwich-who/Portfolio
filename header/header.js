const HEADER_FRAGMENT_HTML = `<header
  ...
  >
    <div class="mx-auto max-w-6xl px-4 py-3">
      <div class="flex flex-col gap-1.5">
        <a
          class="nav-item rounded-xl px-3 py-2.5 text-sm font-medium text-white/70 hover:bg-white/10 hover:text-white transition"
          data-nav-link="projects"
          href="#projects"
          >Projects</a
        >
...
class HeaderSection extends HTMLElement {
  connectedCallback() {
    window.renderFragmentIntoElement(this, HEADER_FRAGMENT_HTML, {
